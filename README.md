...
enc = [0x29BE, 0x244E, 0x3593, 0x2759, 0x463, 0x2446, 0x459, 0x28A8, 0x2FDE, 0x2FDD, 0x26FF, 0x455, 0x2710, 0x24A9, 0x38D7, 0x448, 0x400, 0x2796, 0x2EFA, 0x2BA0, 0x2FDA, 0x38E2, 0x40C, 0x3708, 0x2490, 0x3284, 0x293E, 0x2496, 0x2E34, 0x27AE, 0x45C, 0x2A16, 0x24A0, 0x3630, 0x27B8, 0x426, 0x24A8, 0x42A, 0x2956, 0x3000, 0x3002, 0x26FE, 0x434, 0x2702, 0x24B8, 0x3912, 0x47C, 0x43E, 0x27D4, 0x2F38, 0x2BDE, 0x3018, 0x3920, 0x44A, 0x3746, 0x24CE, 0x32C2, 0x297C, 0x24D4, 0x2E72, 0x27EC, 0x49A, 0x2A54, 0x24DE, 0x366E, 0x27F6, 0x464, 0x24E6, 0x468, 0x2994, 0x303E, 0x3040, 0x273C, 0x472, 0x2740, 0x24F6, 0x3950, 0x4BA, 0x47C, 0x2812, 0x2F76]
# Lay tu file tmp.enc
...
len = len(Str)
for i in range (81):
    flag.append(chr((enc[i] + ord(Str[i % len]) - i) ^ (ord(Str[i % len]) * ord(Str[i % len]) + i)))
